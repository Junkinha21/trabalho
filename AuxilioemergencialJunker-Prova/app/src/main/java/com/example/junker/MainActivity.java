...
public class MainActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if(ps.getNasc() != null && ps.getCpf() != 0 && ps.getRenda() != 0) {
                    if(check(ps)){
                        ...
                        Toast toast = Toast.makeText(getApplicationContext(), "Verifique sua idade ou seu salário", Toast.LENGTH_LONG);
                        toast.setMargin(0,0);
                        toast.show();
                    }
    ...
    private Pessoa getData (){
        ...
        try {
            ...
            Toast toast = Toast.makeText(getApplicationContext(), "Alguns campos não estão preenchidos", Toast.LENGTH_LONG);
            toast.setMargin(0,0);
            toast.show();
